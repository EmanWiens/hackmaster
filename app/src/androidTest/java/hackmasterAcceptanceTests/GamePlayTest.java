...
public class GamePlayTest extends ActivityInstrumentationTestCase2{
    ...
    public void testMultiplePlayerGame() {
        ...
        assertEquals("Health: 19%", textPlayerHealh.getText().toString());
        assertEquals("Health: 19%", textEnemyHealh.getText().toString());
        assertEquals("\nHackCoin Rate: 3" + "\n----\n" + "HackCoin: 20", textPlayerMiner.getText().toString());
        assertEquals("\nCPU Rate: 2" + "\n----\n" + "CPU: 29", textPlayerCPU.getText().toString());
        assertEquals("\nBotnet gen: 1" + "\n----\n" + "Botnet: 15", textPlayerBotnet.getText().toString());

        assertEquals("\nHackCoin Rate: 1" + "\n----\n" + "HackCoin: 38", textEnemyMiner.getText().toString());
        assertEquals("\nCPU Rate: 2" + "\n----\n" + "CPU: 62", textEnemyCPU.getText().toString());
        assertEquals("\nBotnet gen: 2" + "\n----\n" + "Botnet: 10", textEnemyBotnet.getText().toString());
        solo.clickOnImageButton(2);
        textResult = (TextView) solo.getView(R.id.textViewResult);
        assertEquals("PLAYER 1 WON", textResult.getText().toString());
