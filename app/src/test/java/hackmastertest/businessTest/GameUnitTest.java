...
public class GameUnitTest {
    ...
    {
        // TODO this test should be in testGame (game manager has this function)
    ...
    private void testIndividualResources(int health, int hCoin, int hCoinRate, int botnet, int botnetRate , int CPURate , int terraFlops, boolean player1ToCheck ) {
        if (player1ToCheck) {
            assertEquals("The health of player1 should be " + health, health, testGame.getPlayer1().getResources().getHealth());
            assertEquals("The hCoin of player1 should be " + hCoin, hCoin, testGame.getPlayer1().getResources().gethCoin());
            assertEquals("The hCoinRate of player1 should be " + hCoinRate, hCoinRate, testGame.getPlayer1().getResources().gethCoinRate());
            assertEquals("The botnet of player1 should be " + botnet, botnet, testGame.getPlayer1().getResources().getBotnet());
            assertEquals("The botnetRate of player1 should be " + botnetRate, botnetRate, testGame.getPlayer1().getResources().getBotnetRate());
            assertEquals("The CPURate of player1 should be " + CPURate, CPURate, testGame.getPlayer1().getResources().getCpuRate());
            assertEquals("The terraFlops of player1 should be " + terraFlops, terraFlops, testGame.getPlayer1().getResources().getCpu());
        }
        else {
            assertEquals("The health of player2 should be " + health, health, testGame.getPlayer2().getResources().getHealth());
            assertEquals("The hCoin of player2 should be " + hCoin, hCoin, testGame.getPlayer2().getResources().gethCoin());
            assertEquals("The hCoinRate of player2 should be " + hCoinRate, hCoinRate, testGame.getPlayer2().getResources().gethCoinRate());
            assertEquals("The botnet of player2 should be " + botnet, botnet, testGame.getPlayer2().getResources().getBotnet());
            assertEquals("The botnetRate of player2 should be " + botnetRate, botnetRate, testGame.getPlayer2().getResources().getBotnetRate());
            assertEquals("The CPURate of player2 should be " + CPURate, CPURate, testGame.getPlayer2().getResources().getCpuRate());
            assertEquals("The terraFlops of player2 should be " + terraFlops, terraFlops, testGame.getPlayer2().getResources().getCpu());
        }
    }
    private void testEveryoneResources(int [] Player1Res ,int [] Player2Res ) {
        assertEquals("The health of player1 should be " + Player1Res[0], Player1Res[0], testGame.getPlayer1().getResources().getHealth());
        assertEquals("The hCoin of player1 should be " + Player1Res[1], Player1Res[1], testGame.getPlayer1().getResources().gethCoin());
        assertEquals("The hCoinRate of player1 should be " + Player1Res[2], Player1Res[2], testGame.getPlayer1().getResources().gethCoinRate());
        assertEquals("The botnet of player1 should be " + Player1Res[3], Player1Res[3], testGame.getPlayer1().getResources().getBotnet());
        assertEquals("The botnetRate of player1 should be " + Player1Res[4], Player1Res[4], testGame.getPlayer1().getResources().getBotnetRate());
        assertEquals("The CPURate of player1 should be " + Player1Res[5], Player1Res[5], testGame.getPlayer1().getResources().getCpuRate());
        assertEquals("The terraFlops of player1 should be " + Player1Res[6], Player1Res[6], testGame.getPlayer1().getResources().getCpu());

        assertEquals("The health of player2 should be " + Player2Res[0], Player2Res[0], testGame.getPlayer2().getResources().getHealth());
        assertEquals("The hCoin of player2 should be " + Player2Res[1], Player2Res[1], testGame.getPlayer2().getResources().gethCoin());
        assertEquals("The hCoinRate of player2 should be " + Player2Res[2], Player2Res[2], testGame.getPlayer2().getResources().gethCoinRate());
        assertEquals("The botnet of player2 should be " + Player2Res[3], Player2Res[3], testGame.getPlayer2().getResources().getBotnet());
        assertEquals("The botnetRate of player2 should be " + Player2Res[4], Player2Res[4], testGame.getPlayer2().getResources().getBotnetRate());
        assertEquals("The CPURate of player2 should be " + Player2Res[5], Player2Res[5], testGame.getPlayer2().getResources().getCpuRate());
        assertEquals("The terraFlops of player2 should be " + Player2Res[6], Player2Res[6], testGame.getPlayer2().getResources().getCpu());
